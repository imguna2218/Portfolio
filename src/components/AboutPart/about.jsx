...
const About = () => {
  return (
    <>
      <div id="aboutpart" className="flex flex-col h-screen w-screen bg-cover bg-center"
        style={{ background: 'linear-gradient(45deg, rgba(0, 0, 0, 0.673), rgba(18, 0, 72, 0.76)), rgba(163, 1, 1, 0.678)' }}>
        ...
        <div id="mainContent" className="flex flex-1">
          ...
          <div id="imageDiv" className="flex-1 flex justify-center items-center">
            <div id='actualImageDiv' className="myimage rounded-full overflow-hidden" style={{ width: '40%', padding: '40px' }}>
